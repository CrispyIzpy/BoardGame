...
const LeftRoad = (
  ...
  return (
    <div
      className="road-wrapper road-left-wrapper"
      onClick={() => onClick(0, id)}
    >
...
const LeftUnderRoad = (
  ...
  return (
    <div
      className="road-wrapper road-left-under-wrapper"
...
// id 2
const RightUnderRoad = (
  id: number,
  onClick: (roadId: number, id: number) => void
) => {
  return (
    <div
      className="road-wrapper road-right-under-wrapper"
...
const RightRoad = (
  ...
  return (
    <div
      className="road-wrapper road-right-wrapper"
...
const RightTopRoad = (
  ...
  return (
    <div
      className="road-wrapper road-right-top-wrapper"
      onClick={() => onClick(4, id)}
    >
      <div className="road"></div>
    </div>
  );
...
const LeftTopRoad = (
  ...
  return (
    <div
      className="road-wrapper road-left-top-wrapper"
      onClick={() => onClick(5, id)}
    >
      <div className="road"></div>
    </div>
  );
